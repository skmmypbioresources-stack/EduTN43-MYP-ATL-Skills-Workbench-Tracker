...
import { Sparkles, HelpCircle, Layers, Link as LinkIcon, User, ClipboardList, CheckCircle2, ArrowRight } from 'lucide-react';
            ...
            {assignedTasks.map((at) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center justify-center gap-1.5 rounded-lg bg-indigo-600 px-3 py-2 text-xs font-bold text-white shadow-2xs hover:bg-indigo-700 transition-all cursor-pointer"
                >
                  <span>Start Assigned Task</span>
